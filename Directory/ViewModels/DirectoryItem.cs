...
namespace MyFileWpfFileExplorer
{
    ...
    public class DirectoryItem : BaseViewModel
    {
        ...
        public bool IsSelected { get { return _isSelected; } set { _isSelected = value; if (IsSelected) CurrentItem = this; } }
        public bool IsFTPSelected
        {
            get { return _isFTPSelected; }
            set { _isFTPSelected = value; if (IsFTPSelected) CurrentFTPItem = this; }
        }
        ...
        {
            // Create commands
            this.ExpandCommand = new RelayCommand(Expand, null);
